...
function verifyUserLoginPassword(PDO $pdo, string $email, string $password) {
    ...
    function addBooking(PDO $pdo, string $first_name, string $last_name, string $phone) {
        $sql = "INSERT INTO `reservation` (`first_name`, `last_name`, `phone`) VALUES (:first_name, :last_name, :phone);";
        $query = $pdo->prepare($sql);
